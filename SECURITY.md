...
If you find a security vulnerability in DataSluice, please report it through [GitHub's private vulnerability reporting](https://github.com/bocklabs/datasluice/security/advisories/new). This keeps the details private while we work on a fix.
