...
class SyncUDataUsersTokensService(Protocol):
    ...
    def get_me(self, permissions: EffectivePermissions) -> object: ...
    def update_me(
        self,
    ...
    def my_reuses(self, permissions: EffectivePermissions) -> object: ...
    def my_datasets(self, permissions: EffectivePermissions) -> object: ...
    def my_metrics(self, permissions: EffectivePermissions) -> object: ...
    def my_org_datasets(self, permissions: EffectivePermissions, q: str | None = None) -> object: ...
    def my_org_community_resources(self, permissions: EffectivePermissions, q: str | None = None) -> object: ...
    def my_org_reuses(self, permissions: EffectivePermissions, q: str | None = None) -> object: ...
    def my_org_discussions(self, permissions: EffectivePermissions, q: str | None = None) -> object: ...
    def list_api_tokens(self, permissions: EffectivePermissions) -> object: ...
    ...
    def list_org_invitations(self, permissions: EffectivePermissions) -> object: ...
    ...
    def list_users(self, permissions: EffectivePermissions, query: UserListQuery | None = None) -> object: ...
    def create_user(
        self,
    ...
    def my_org_topics(self, permissions: EffectivePermissions, query: UserListQuery | None = None) -> object: ...
...
class AsyncUDataUsersTokensService(Protocol):
    ...
    async def get_me(self, permissions: EffectivePermissions) -> object: ...
    async def update_me(
        self,
        client_input: UserUpdateInput,
        permissions: EffectivePermissions,
    ...
    async def my_reuses(self, permissions: EffectivePermissions) -> object: ...
    async def my_datasets(self, permissions: EffectivePermissions) -> object: ...
    async def my_metrics(self, permissions: EffectivePermissions) -> object: ...
    async def my_org_datasets(self, permissions: EffectivePermissions, q: str | None = None) -> object: ...
    async def my_org_community_resources(self, permissions: EffectivePermissions, q: str | None = None) -> object: ...
    async def my_org_reuses(self, permissions: EffectivePermissions, q: str | None = None) -> object: ...
    async def my_org_discussions(self, permissions: EffectivePermissions, q: str | None = None) -> object: ...
    async def list_api_tokens(self, permissions: EffectivePermissions) -> object: ...
    ...
    async def list_org_invitations(self, permissions: EffectivePermissions) -> object: ...
    ...
    async def list_users(self, permissions: EffectivePermissions, query: UserListQuery | None = None) -> object: ...
    ...
    async def my_org_topics(self, permissions: EffectivePermissions, query: UserListQuery | None = None) -> object: ...
