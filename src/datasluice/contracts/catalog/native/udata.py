...
class SyncUDataRootProfileService(Protocol):
    ...
    def datasets_csv(self, query: SiteDatasetCsvQuery | None = None) -> SiteDocument: ...

    def resources_csv(self, query: SiteDatasetCsvQuery | None = None) -> SiteDocument: ...

    def organizations_csv(self, query: SiteOrganizationCsvQuery | None = None) -> SiteDocument: ...

    def reuses_csv(self) -> SiteDocument: ...

    def dataservices_csv(self) -> SiteDocument: ...
...
class AsyncUDataRootProfileService(Protocol):
    ...
    async def datasets_csv(self, query: SiteDatasetCsvQuery | None = None) -> SiteDocument: ...

    async def resources_csv(self, query: SiteDatasetCsvQuery | None = None) -> SiteDocument: ...

    async def organizations_csv(self, query: SiteOrganizationCsvQuery | None = None) -> SiteDocument: ...

    async def reuses_csv(self) -> SiteDocument: ...

    async def dataservices_csv(self) -> SiteDocument: ...
